...
%	 end
      proc {HARMONIC_CONSONANCE Voice1 Voice2 Pos}
	 {HARMONIC_INTERVAL_MOD Voice1 Voice2 Pos {FD.int [0 3 4 7 8 9 12]}}
      end
	 ...
	 {HARMONIC_INTERVAL_MOD Voice1 Voice2 Pos {FD.int [0 7 12]}}
      end
     
      proc {HARMONIC_IMPERFECT_CONSONANCE Voice1 Voice2 Pos}
	 %dis Voice1 \=: Voice2 []
	    {HARMONIC_INTERVAL_MOD Voice1 Voice2 Pos {FD.int [3 4 8 9]}}
	 %end
...
proc {HARMONIC_DISSONANCE Voice1 Voice2 Pos}
   {HARMONIC_INTERVAL_MOD Voice1 Voice2 Pos {FD.int [1 2 5 6 10 11]}}   
end
