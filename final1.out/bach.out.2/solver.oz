...
%   end
  ...
  %    Solution = {Score.makeScore sim(items:[{MakeVoice {FD.list NP 40#59} L} {MakeVoice {FD.list NP 48#69} L} {MakeVoice {FD.list NP 57#76} L} {MakeVoice {FD.list NP 60#81} L} ]  timeUnit:beats) unit}
    Solution = {Score.makeScore sim(items:[{MakeVoice {FD.list NP 30#100} L} {MakeVoice {FD.list NP 30#100} L} {MakeVoice {FD.list NP 30#100} L} {MakeVoice {FD.list NP 30#100} L} ]  timeUnit:beats) unit}
